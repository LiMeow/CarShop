...
import net.thumbtack.shop.config.JwtSettings;
import net.thumbtack.shop.jwt.AuthenticatedJwtToken;
...
public class JsonWebTokenService implements JwtTokenService {
    ...
    public String createToken(User user) {
        LOGGER.debug("JsonWebTokenService create token for user '{}'", user);
        ...
        claims.put(AUTHORITY, user.getUserRole());
    ...
    public String createToken(AuthRequest request) {
        ...
        claims.put(AUTHORITY, request.getUserRole());
