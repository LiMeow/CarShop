insert into car (model,picture, price, production,available) values ('Audi A8','/img/AudiA8.jpg',6150000,2017,true);
insert into car (model,picture, price, production,available) values ('BMW i8','/img/BMWi8.jpg',11490000,2017,true);
insert into car (model,picture, price, production,available) values ('Chrysler Neon II','/img/ChryslerNeonII.jpg',190000,2001,true);
